...
void selection(BaseDatos &train, BaseDatos &testVal, vector<Features> &Pactual, vector<Features> &Ppadres, int k_torneo, int cromosomas, int activarGeneracional);
void crossing(vector<Features> &Ppadres, vector<Features> &Pintermedia, double prob_c, int genes, int cromosomas);
void uniformMutation(vector<Features> &Pintermedia, vector<Features> &Phijos, double prob_g, int genes, int cromosomas, int estacional=0);
